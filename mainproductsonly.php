...
<?php
	...
	$query="SELECT COUNT(*) as num FROM t_product_mst WHERE username= 'pavan' AND prd_cat= '$cat' AND prd_status='Available' ";
...
?>
<?php
    $get= @mysql_query("SELECT * FROM t_product_mst WHERE username= 'pavan' AND prd_cat= '$cat' AND prd_status='Available' LIMIT $start, $limit ")or die(mysql_error());
 ...
 <?php
    $get_price= @mysql_query("SELECT * FROM t_price_mst WHERE username= 'pavan' AND prd_id='$prid' ")or die(mysql_error());
